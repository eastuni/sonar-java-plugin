 ...
 */
public class CbpStandardCheckRegistrar implements CheckRegistrar {
	...
	public void register(RegistrarContext registrarContext) {
		...
		registrarContext.registerClassesForRepository(CbpStandardRulesDefinition.REPOSITORY_KEY,
				CbpStandardRulesList.getJavaChecks(), CbpStandardRulesList.getJavaTestChecks());
	}
	/**
	 * Lists all the main checks provided by the plugin
	 */
	public static List<Class<? extends JavaCheck>> checkClasses() {
		return CbpStandardRulesList.getJavaChecks();
	}
	...
	public static List<Class<? extends JavaCheck>> testCheckClasses() {
		return CbpStandardRulesList.getJavaTestChecks();
	}
}
