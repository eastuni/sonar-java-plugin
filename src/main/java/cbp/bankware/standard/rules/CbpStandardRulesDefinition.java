 ...
 */
public class CbpStandardRulesDefinition implements RulesDefinition {

  // don't change that because the path is hard coded in CheckVerifier
  private static final String RESOURCE_BASE_PATH = "/org/sonar/l10n/java/rules/squid";

  public static final String REPOSITORY_KEY = "CBP-Standard-Rule";
  ...
  public void define(Context context) {
    ...
    List<Class> checks = CbpStandardRulesList.getChecks();
  ...
  private void addMetadata(NewRule rule, String metadataKey) {
    URL resource = CbpStandardRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.json");
    if (resource != null) {
  ...
  private static void addHtmlDescription(NewRule rule, String metadataKey) {
    URL resource = CbpStandardRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.html");
    if (resource != null) {
